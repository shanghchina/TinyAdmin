...
namespace Tiny.OPS.WebApi.Filter
{
    ...
    public class ApiAuthorizeAttribute : ActionFilterAttribute
    {
        ...
        //private static IMd5ValidateDomainService Md5ValidateDomainService => IoC.Resolve<IMd5ValidateDomainService>();
        //private static IAppidDomainService AppidDomainService => IoC.Resolve<IAppidDomainService>();
