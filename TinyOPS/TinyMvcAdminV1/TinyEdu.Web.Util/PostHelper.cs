...
namespace TinyEdu.Web.Util
{
    ...
    public static class PostHelper
    {
        ...
        public static string GetPostResult(string url, string json)
        {
            ...
            var _stringResult = _response_result.Content.ReadAsStringAsync().Result;
        ...
        ///// <returns></returns>
        //public static string GetResult(string url, string json)
        //{
        //    string appId = "", transactionId = "", timestamp = "", sign = "";
        //    string postJson = string.Empty;
        //    var signdata = string.Empty;
        ...
        //    var response = _client.GetAsync(url, _content).ConfigureAwait(false);
