...
using TinyEdu.Data.Repository;
using TinyEdu.CodeGenerator.Model;
using TinyEdu.Util;
...
namespace TinyEdu.CodeGenerator.Template
{
    public class SingleTableTemplate
    {
        ...
        public BaseConfigModel GetBaseConfig(string path, string userName, string tableName, string tableDescription, List<string> tableFieldList)
        {
            ...
            baseConfigModel.OutputConfig.OutputEntity = string.Format("{0}\\TinyEdu.Entity", path);
            baseConfigModel.OutputConfig.OutputBusiness = string.Format("{0}\\TinyEdu.Business", path);
            baseConfigModel.OutputConfig.OutputWeb = string.Format("{0}\\TinyEdu.Web\\TinyEdu.Admin.Web", path);
        ...
        public string BuildEntity(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using TinyEdu.Util;");
            sb.AppendLine();

            sb.AppendLine("namespace TinyEdu.Entity." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildEntityParam(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("namespace TinyEdu.Model.Param." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildService(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using TinyEdu.Util;");
            sb.AppendLine("using TinyEdu.Util.Extension;");
            sb.AppendLine("using TinyEdu.Util.Model;");
            sb.AppendLine("using TinyEdu.Data;");
            sb.AppendLine("using TinyEdu.Data.Repository;");
            sb.AppendLine("using TinyEdu.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using TinyEdu.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");

            sb.AppendLine();

            sb.AppendLine("namespace TinyEdu.Service." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildBusiness(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using TinyEdu.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using TinyEdu.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using TinyEdu.Service." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace TinyEdu.Business." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildController(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using TinyEdu.Util;");
            sb.AppendLine("using TinyEdu.Util.Model;");
            sb.AppendLine("using TinyEdu.Entity;");
            sb.AppendLine("using TinyEdu.Model;");
            sb.AppendLine("using TinyEdu.Admin.Web.Controllers;");
            sb.AppendLine("using TinyEdu.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using TinyEdu.Business." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using TinyEdu.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace TinyEdu.Admin.Web.Areas." + baseConfigModel.OutputConfig.OutputModule + ".Controllers");
            sb.AppendLine("{");
        ...
        public async Task<List<KeyValue>> CreateCode(BaseConfigModel baseConfigModel, string code)
        {
            ...
            if (!string.IsNullOrEmpty(param["CodeEntity"].ParseToString()))
            {
                ...
                string codePath = baseConfigModel.OutputConfig.OutputEntity + "\\TinyEdu.Entity\\" + baseConfigModel.OutputConfig.OutputModule + "\\" + baseConfigModel.FileConfig.EntityName + ".cs";
            ...
            if (!param["CodeEntityParam"].IsEmpty())
            {
                ...
                string codePath = baseConfigModel.OutputConfig.OutputEntity + "\\TinyEdu.Model\\Param\\" + baseConfigModel.OutputConfig.OutputModule + "\\" + baseConfigModel.FileConfig.EntityParamName + ".cs";
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeService"].IsEmpty())
            {
                ...
                string codePath = baseConfigModel.OutputConfig.OutputBusiness + "\\TinyEdu.Service\\" + baseConfigModel.OutputConfig.OutputModule + "\\" + baseConfigModel.FileConfig.ServiceName + ".cs";
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeBusiness"].IsEmpty())
            {
                ...
                string codePath = baseConfigModel.OutputConfig.OutputBusiness + "\\TinyEdu.Business\\" + baseConfigModel.OutputConfig.OutputModule + "\\" + baseConfigModel.FileConfig.BusinessName + ".cs";
                if (!File.Exists(codePath))
                {
