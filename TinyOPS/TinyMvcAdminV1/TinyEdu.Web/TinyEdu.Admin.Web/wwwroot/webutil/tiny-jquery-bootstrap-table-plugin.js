; (function ($) {
    "use strict";
    $.fn.tinyTable = function (option, param) {
        //如果是调用方法
        if (typeof option == 'string') {
            return $.fn.tinyTable.methods[option](this, param);
        }

        //如果是初始化组件
        var _option = $.extend({}, $.fn.tinyTable.defaults, option || {});
        var target = $(this);
        target.bootstrapTable(_option);
        return target;
    };

    $.fn.tinyTable.methods = {
